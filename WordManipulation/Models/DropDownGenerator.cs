    ...
    public class DropDownGenerator
    {
        ...
        public List<Attorney> GetNotaries()
        {
            ...
            list.Add(new Attorney
            {
                ...
                City = "Αθήνας",
                Pronoun = "της",
                Description = "της Ανδριανοπούλου Ν. Δήμητρας, συμβολαιογράφου Αθηνών που εδρεύει στην ΑΘήνα, στην οδό Ακαδημίας, αριθμός 41 με Α.Φ.Μ. 055298233, Δ.Ο.Υ. Δ' Αθηνών",
