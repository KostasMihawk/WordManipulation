...
namespace WordManipulation.Models
{
    public class Summary
    {
        ...
        {
            return docXManager.PraxiPlistiriasmou(form);
            //var r = new Random();
            //ITranslator translator = new Translator();
            //DayCalculator calc = new DayCalculator();
            //TextGenerator textGenerator = new TextGenerator();
            ...
            //    firstParagraph.Append("(        ) του μηνός Μαΐου").FontSize(fontsize).Font(fontFamily);
        ...
        public MemoryStream CreateEntoliSunexisisPlistiriasmou(Form form)
        {
            return docXManager.EntoliSunexisisPlistiriasmou(form);            
        }
        //TODO Na dw ta kleisimata
        //TODO na ftiaxw to panw koubi na duleuei kanonika ( me refactor )
        //TODO na epanaferw ts epimelitries (dropdown)
        //TODO DOY ELEUSINAS
        //TODO kata tou ofeileth stn paragrafo akrives adigrafo
        ...
        public string TextPraxhs(string s)
        {
